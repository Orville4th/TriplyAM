...
class TripLyWindow(QMainWindow):
    ...
    def _on_ltype_changed(self, ltype):
        ...
        is_voronoi = ltype in ("Voronoi (Random)", "Voronoi (Structure)")
        # TPMS-only controls
    ...
    def _on_lat_done(self, pid, verts, faces):
        ...
        if pi:
            ...
            is_voronoi = ltype_str in ("Voronoi (Random)", "Voronoi (Structure)")
            if is_voronoi:
    ...
    def _show_disclaimer(self):
        ...
        # version string (e.g. "1.0.1") in BOTH the equality check below AND the
        ...
        if self._cfg.get("terms_agreed_version") == "1.0.1":
        ...
        hdr_lbl = QLabel(
            ...
            "<br><span style='color:#888;font-size:12px;'>Open Source Software &nbsp;·&nbsp; v1.0.1</span>"
        )
        ...
        <p><b>4. GNU General Public License v3 (GPL v3)</b><br>
        TriplyAM is released under the <b>GNU General Public License v3</b>.
        You are free to use, study, modify, and distribute this software under the same license.<br><br>
        <b>Key conditions:</b> Any modified or derived version you distribute must also be
        licensed under GPL v3 and include the full source code. You may use this software
        for any purpose including commercial use, but you may not distribute it under a
        more restrictive license.<br><br>
        THE SOFTWARE IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND.<br><br>
        Full license text: <a href='https://www.gnu.org/licenses/gpl-3.0.html'>gnu.org/licenses/gpl-3.0</a><br>
        Source code: <a href='https://github.com/Orville4th/TriplyAM'>github.com/Orville4th/TriplyAM</a></p>
        ...
        if result == QDialog.DialogCode.Accepted and chk.isChecked():
            self._agreed_to_terms = True
            self._cfg["terms_agreed_version"] = "1.0.1"
            save_config(self._cfg)
            return True
        return False
    ...
    def _show_whats_new(self):
        ...
        if self._cfg.get("whats_new_shown_version") == "1.0.1":
            return
        # Mark as shown for this version
        self._cfg["whats_new_shown_version"] = "1.0.1"
        save_config(self._cfg)
        ...
        dlg = QDialog(self)
        dlg.setWindowTitle("What's new in TriplyAM 1.0.1")
        dlg.setMinimumWidth(480)
        dlg.setMinimumHeight(400)
        lay = QVBoxLayout(dlg)
        lay.setSpacing(10)

        hdr = QLabel("<b style='font-size:14px;'>What's new in 1.0.1</b>")
        lay.addWidget(hdr)
        ...
        <p><b>What's new:</b></p>
        <ul>
          <li><b>License updated to GPL v3</b> — required for PyQt6 compatibility</li>
          <li><b>Startup agreement</b> — now shows full GPL v3 conditions</li>
        </ul>
        <p style='color:#888; font-size:11px;'>
    ...
    def _dlg_about(self):
        ...
        <h3>1.0.1 — License Update <span class='tag'>current</span></h3>
        <ul>
          <li>License changed from MIT to GNU GPL v3 — required for PyQt6 compatibility</li>
          <li>GPL v3 full text and conditions now shown in startup agreement</li>
          <li>README updated with full dependency acknowledgements</li>
        </ul>

                <!-- !! UPDATE THIS CHANGELOG ON EVERY RELEASE !! -->
        <h3>1.0.0 — Stable Release</h3>
        <ul>
          <li>First stable release — all TPMS and Voronoi lattice types working with correct outer shell</li>
          <li>Shell-on fixed — part-(inner-lattice) boolean approach with correct component handling</li>
          <li>Voronoi (Random) and Voronoi (Structure) with Lloyd relaxation</li>
          <li>All four TPMS types: Gyroid, Schwarz P, Schwarz D, Schoen I-WP</li>
          <li>GPL v3 license, crash logs, export debug log, .3mf auto-extension</li>
        </ul>
